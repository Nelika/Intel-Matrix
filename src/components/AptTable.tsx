...
export const AptTable: React.FC<AptTableProps> = ({
  ...
  if (data.length === 0) {
    return (
      <div className="bg-white border border-slate-200 rounded-xl p-12 text-center my-6 shadow-sm">
                ...
                >
                  ...
                  <td className="py-3.5 px-3 text-center">
                    <button
                      ...
                      className="p-1.5 bg-slate-100 border border-slate-200 text-slate-600 hover:text-blue-600 hover:bg-blue-50 hover:border-blue-300 rounded transition-all"
                    >
